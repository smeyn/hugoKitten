...
+++
[Scaffolds]( {{< relref "craft/Scaffold.md" >}}) are a vital mid-game craftable resource used primarily for industrial construction, storage expansion, and the development of the colony's naval fleet. They are produced in the [Workshop]( {{< relref "buildings/Workshop.md" >}}) at a base cost of **50 Beams** per craft.
...
Scaffolds serve as a foundational material for several critical bonfire structures and religious buildings:
*   **Observatories:** Each observatory requires **50 scaffolds**. These are essential for increasing the science cap and automating the collection of **Starcharts**.
*   **Production Buildings:** They are a required component for **Oil Wells (25 scaffolds)** and **Quarries (50 scaffolds)**, both of which are necessary for stabilizing energy and mineral supplies.
...
As a crafted resource, scaffolds are **normally lost upon resetting** the game. To preserve a portion of your stockpile across runs, you must possess at least one [Chronosphere]( {{< relref "buildings/Chronosphere.md" >}}) and the [Flux Condensator]( {{< relref "upgrade/Flux_Condensator.md" >}}) workshop upgrade. The amount carried over is calculated based on the number of chronospheres and the square root of the total quantity held at the time of reset.