...
*   **Planet Cracker:** Uranium is produced by the **Planet Cracker** structure [1, 6]. This structure's output is affected by the [Dune]( {{< relref "dune.md" >}}) cycle, which can increase its uranium output by **+10%** [7].
