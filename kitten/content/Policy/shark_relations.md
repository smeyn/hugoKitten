...
### **Trade Mechanics**
Sharks are discovered around **Year 20** (or **Year 1** if you have the [Diplomacy]( {{< relref "Policy/Diplomacy.md" >}}) metaphysics upgrade). Their attitude is **Neutral**, meaning they provide no baseline bonus or penalty to trade.

*   **Primary Trade:** You give **100 Iron**; they give **Catnip**.
*   **Secondary Gains:** Successful trades have a chance to yield [Parchment]( {{< relref "craft/Parchment.md" >}}) (25%), [Manuscripts]( {{< relref "resource/manuscript.md" >}}) (15%), and [Compendiums]( {{< relref "resource/Compendium.md" >}}) (10%).
*   **Seasonal Bonus:** They are most effective in **Winter**, providing a **+45% bonus** to catnip rewards.
*   **Iron Will Strategy:** In a "Black Sky" challenge, Sharks trade iron for [Science]( {{< relref "resource/science.md" >}}) instead of catnip.

### **Shark Relations Policies**
Once you reach **Shark Embassy Level 20** and possess the [Diplomacy]( {{< relref "Policy/Diplomacy.md" >}}) metaphysics upgrade, you can enact one of three **mutually exclusive** policies. Choosing one locks out the other two for that run.

| Policy | Effect | Best Use Case |
| :--- | :--- | :--- |
| **Scribes** | +25% Parchment chance, +15% Manuscript chance; **+50% Iron cost** per trade. | Accelerating science when you have a massive surplus of Iron. |
| **Merchants** | +3% Trade Ratio (scales up to +30% based on total trades completed). | Long-term scaling of all trade rewards. |
| **Botanists** | -75% Bio Lab energy, +1% Brewery catpower bonus, +25% Wood crafting bonus. | Managing energy deficits or boosting late-game wood production. |
