...
Here are the specific details regarding this upgrade:

*   **Prerequisite Technology:** Advanced Automation is unlocked by researching the [Industrialization]( {{< relref "techs/Industrialization.md" >}}) technology.
*   **Building Association:** This upgrade is associated with the [Steamworks]( {{< relref "buildings/Steamworks.md" >}}) building.
*   **Cost:** The upgrade requires **100,000 Science**, **75 Gears**, and **25 Blueprints**.
*   **Effect:** The Advanced Automation upgrade causes the core [Workshop Automation]( {{< relref "upgrade/Workshop_Automation.md" >}}) function to be activated **twice per year**.
