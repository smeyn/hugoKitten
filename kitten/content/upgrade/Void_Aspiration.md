...
[Void Aspiration]( {{< relref "upgrade/Void_Aspiration.md" >}}) is a late-game **workshop upgrade** that becomes available after researching the [Void Space]( {{< relref "techs/Void_Space.md" >}}) technology. Enacting this upgrade requires a specific investment of **15 Time Crystals and 2,000 Antimatter**.
...
*   **Void Hoover:** These structures increase the maximum amount of [void]( {{< relref "resource/void.md" >}}) that may be gained during a [Temporal Paradox]( {{< relref "guides/temporal_paradox.md" >}}) day by **1 unit**.
