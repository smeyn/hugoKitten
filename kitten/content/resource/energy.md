...
| **Sunlifter** | N/A (Space Structure) | N/A (Antimatter) | Sunlifters produce Antimatter when the year changes, provided energy is positive [15]. | [15] |
...
*   **Cycles:** The [Helios]( {{< relref "helios.md" >}}) cycle increases **Sunlifter** energy output by **+50%** [17]. Conversely, the [T-minus]( {{< relref "t_minus.md" >}}) cycle decreases **Sunlifter** energy output by **-50%** [17].
*   **Policies:** The [Dark Nova]( {{< relref "dark_nova.md" >}}) cryptotheology upgrade provides a **+2% global energy production** bonus [18].
