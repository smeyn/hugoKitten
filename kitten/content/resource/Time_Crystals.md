...
[Time Crystals]( {{< relref "time_crystals.md" >}}) (TC) are a crucial, uncommon resource that marks the transition into the late-game phase, often referred to as Phase 2 or the Unicorn/Time Crystal Era [1-3]. They are primarily used for time manipulation, unlocking advanced physics and void technologies, and are the precursor to [Relics]( {{< relref "resource/relic.md" >}}).

### Acquisition and Generation

Time Crystals cannot be produced by standard buildings or jobs; they must be acquired through specific late-game conversions and trade:
...
Time Crystals are essential for advanced technological and religious progression, especially concerning time mechanics and void resources:

*   **Refining into Relics:** **25 Time Crystals** can be refined into **1 Relic** [12]. Relics are necessary for buying Cryptotheology buildings like the Black Obelisk and Black Nexus [13].
*   **Time and Void Science:** TCs are prerequisites for key late-game technologies:
    *   [Chronophysics:]( {{< relref "chronophysics.md" >}}) Costs **5 Time Crystals** [14].
    *   [Tachyon Theory:]( {{< relref "tachyon_theory.md" >}}) Costs **25 Time Crystals** and 1 Relic [14].
    *   [Void Space:]( {{< relref "void_space.md" >}}) Costs **30 Time Crystals** and 100 Void [15].
    *   [Paradox Theory:]( {{< relref "paradox_theory.md" >}}) Costs **40 Time Crystals** and 250 Void [15].
*   **Time Manipulation and Antimatter:** Time Crystals are integral to the [Chronoforge]( {{< relref "chronoforge.md" >}}) system (unlocked by Tachyon Theory) [16].
...
> Time Crystals act as the key to temporal mechanics in *Kittens Game*. If Unobtainium is the material that unlocks space, [Time Crystals]( {{< relref "time_crystals.md" >}}) are the resource that unlocks control over the flow of time itself, allowing kittens to either speed up their civilization or carry advantages across dimensional resets.